========================================================================
    APLICACIÓN DE CONSOLA: Mailslot_Refactoring01 Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Mailslot_Refactoring01.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación Mailslot_Refactoring01.


Mailslot_Refactoring01.vcxproj
...
Mailslot_Refactoring01.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado Mailslot_Refactoring01.pch y un archivo de tipos precompilados llamado StdAfx.obj.
